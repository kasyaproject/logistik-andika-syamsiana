    ...
    <main class="">
        <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
            ...
            <div class="relative p-6 mt-6 overflow-x-auto bg-white shadow-sm dark:bg-gray-800 sm:rounded-lg">
                ...
                <form action="{{ route('productIn.update', $productIn->id) }}" method="POST" class="max-w-7xl sm:mx-10">
                    @csrf
                    @method('patch')
                    <div class="mb-5">
                        ...
                        <select id="product_id" name="product_id"
                            ...
                            @foreach ($product as $item)
                                <option value="{{ $item->id }}" @if ($item->id == $productIn->product->id) selected @endif>
                                    {{ $item->name }}
                                </option>
                            @endforeach
                        </select>
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div class="mb-5">
                            ...
                            <select id="origin" name="origin"
                                ...
                                <option value="Supplier A" @if ($productIn->origin == 'Supplier A') selected @endif>
                                    Supplier A
                                </option>
                                <option value="Supplier B" @if ($productIn->origin == 'Supplier B') selected @endif>
                                    Supplier B
                                </option>
                                <option value="Supplier C" @if ($productIn->origin == 'Supplier C') selected @endif>
                                    Supplier C
                                </option>
                                <option value="Supplier D" @if ($productIn->origin == 'Supplier D') selected @endif>
                                    Supplier D
                                </option>
                        ...
                        <div class="mb-5">
                            ...
                            <input type="number" id="qty" name="qty" value="{{ $productIn->quantity }}"
